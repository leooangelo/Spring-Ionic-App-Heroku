...
import br.com.leonardoangelo.app.domain.PagamentoComCartao;
...
import br.com.leonardoangelo.app.repository.CidadeRepository;
...
import br.com.leonardoangelo.app.repository.EstadoRepository;
...
import br.com.leonardoangelo.app.repository.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2,cat3,cat4,cat5,cat6,cat7,cat7));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "leozinhosp321@hotmail.com", "34352523", TipoCliente.PESSOAFISICA);
